...
<div>
    ...
    <div class="text-center mb-4">
        ...
        <div class="text-center">
            <input type="file" id="user_image" name="user_image" accept="image/*" style="display: none;" onchange="previewImage(event)">

            <label for="user_image" class="profile-img-wrapper">
                <img id="profilePreview"
                    src="{{ asset(Auth::guard('cuser')->user()->user_image ?? 'assets/image/user.png') }}"
    ...
    <form action="{{ route('update_user_profile') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control" id="pancard" name="pancard" value="{{ $user->pancard }}">
                    <label for="pancard"><i class="bi bi-card-text me-2"></i>PAN Card No.</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control" id="gstin" name="gstin" value="{{ $user->gstin }}">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control" id="ps" name="ps" value="{{ $user->ps }}">
        ...
        <div class="d-grid d-flex gap-2 justify-content-center">
            <button class="btn btn-primary btn-register btn-sm" type="submit" onclick="return confirm('Are you sure you want to update your profile?')">Update Profile</button>
            <button class="btn btn-danger btn-sm"><a href="{{ route('user_profile') }}" class="text-white" style="text-decoration: none">Cancel</a></button>
        </div>
