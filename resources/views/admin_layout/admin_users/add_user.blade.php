    ...
    <div class="signup-container">
        <div class="card signup-box">
            ...
            <div class="signup-header text-center mb-4">
                ...
                <h2 class="mt-2">Add User Account</h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="pancard" name="pancard"
                                value="{{ old('pancard') }}" placeholder="PAN Card No.">
                    ...
                    <div class="col-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="address" name="address"
                                value="{{ old('address') }}" placeholder="Village/City">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="ps" name="ps"
                                value="{{ old('ps') }}" placeholder="Police Station">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="confirmPassword"><i class="bi bi-check-circle-fill me-2"></i>Confirm
                                Password</label>
                        </div>
                    </div>
                </div>
