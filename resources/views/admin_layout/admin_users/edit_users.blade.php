        ...
        <form action="{{ route('admin_update_user', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center mb-4">
                <div class="text-center">
                    ...
                    <label for="user_image" class="position-relative d-inline-block rounded-circle overflow-hidden"
                        style="cursor: pointer;">

                        <img id="profilePreview" src="{{ asset($user->user_image ?? 'default-avatar.png') }}" alt="User"
                            class="profile-pictures" {{-- The 'rounded-circle' class is now on the parent label --}}
                            style="object-fit: cover; width: 150px; height: 150px; display: block;"> {{-- Added display:block --}}

                        <span
                            class="position-absolute bottom-0 start-0 w-100 text-center text-white small py-1 mb-2 bg-black bg-opacity-50">
                            Tap to update
                        </span>

                    </label>
                </div>
                <h4 class="mt-3">{{ ucwords($user->name) }}</h4>
            </div>
            <div class="row g-3">
                <div class="col-md-6">
            ...
            <div class="d-grid d-flex gap-2 justify-content-center">
                ...
                <a href="{{ route('manage_users') }}" class="btn btn-danger btn-sm text-white"
